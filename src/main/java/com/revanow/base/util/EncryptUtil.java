...
public class EncryptUtil {
	...
	public static String encryptionPw(String password) {
		return encrypt(getMD5ofStr(password).substring(15, 30));
	}
...
//		System.out.println(encryptionPw("admin"));
		System.out.println(getMD5ofStr("860019031240939"));
	}
}
